                ...
                <div className="flex pt-[150px] pb-[150px] items-center">
                    <div className=" flex flex-col flex-1">
                       <div className="content">
                        ...
                        <a href="" className=" text-[#D71515] w-34 rounded-md pt-[15px] pb-[15px] pr-[35px] pl-[35px] mb-[50px] shadow-lg text-sm font-[700] hover:bg-[#D71515] hover:text-white hover:-translate-y-2  transition duration-300">View CV </a>

                        <div className="flex ">
                            <div className="flex-1">
                                <p className="uppercase tracking-widest font-[500] mb-5">Find me on</p>            
                                <div className="flex gap-10">
                                    <a href="https://www.linkedin.com/in/josef-harvey/" className="bg-white rounded  w-16 h-16 flex items-center justify-center shadow-2xl hover:bg-[#D71515] hover:text-white hover:-translate-y-2  transition duration-300">
                                        <FontAwesomeIcon icon={faLinkedinIn} size="2x" />
                                    </a>
                                    <a href="https://github.com/JosefHarvey" className="bg-white rounded  w-16 h-16 flex items-center justify-center shadow-2xl hover:bg-[#D71515] hover:text-white hover:-translate-y-2  transition duration-300">
                                        <FontAwesomeIcon icon={faGithub} size="2x" />
                                    </a>
                                    <a href="https://www.instagram.com/harveyy_0/" className="bg-white rounded  w-16 h-16 flex items-center justify-center shadow-2xl hover:bg-[#D71515] hover:text-white hover:-translate-y-2  transition duration-300">
                            ...
                            <div className="flex-1">
                                <p className="uppercase tracking-widest font-[500] mb-5">Best skill on</p>
                                 <div className="flex gap-10">
                                    <div className="bg-white rounded  w-16 h-16 flex items-center justify-center shadow-2xl text-blue-300 ">
                                        <FontAwesomeIcon icon={faReact} size="2x" />
                                    </div>
                                    <div className="bg-white rounded  w-16 h-16 flex items-center justify-center shadow-2xl text-[#D71515]">
                                        <FontAwesomeIcon icon={faFigma} size="2x" />
                                    </div>
                                    <div className="bg-white rounded  w-16 h-16 flex items-center justify-center shadow-2xl text-purple-500">
                                        <FontAwesomeIcon icon={faCss} size="2x" />
                                    </div>
                                    <div className="bg-white rounded  w-16 h-16 flex items-center justify-center shadow-2xl text-yellow-300">
            ...
            <div id="features" className="container">
                <div className=" pb-[100px] pt-[100px]">
                     <div>
                        ...
                        <p className="text-6xl font-[700] mb-6">What i <span className="text-8xl font-[500] text-[#D71515]">♡</span> to Do</p>
                    </div>
                    <div className="flex ">
                        <div className="group mr-10  p-10 flex-1.5 shadow-lg rounded-lg hover:shadow-xl hover:bg-[#D71515] bg-white ">
                           <div className="group-hover:text-white group-hover:-translate-y-5  transition duration-300" >
                                <div className="pt-5 pb-5">
                                     <FontAwesomeIcon icon={faCode} size="2x" className="group-hover:text-white text-[#D71515]" />
                                </div>
                        ...
                        <div className="group mr-10  p-10 flex-1.5 shadow-lg rounded-lg hover:shadow-xl hover:bg-[#D71515] bg-white ">
                           <div className="group-hover:text-white group-hover:-translate-y-5  transition duration-300" >
                                <div className="pt-5 pb-5 ">
                                     <FontAwesomeIcon icon={faWindowMaximize} size="2x" className="group-hover:text-white text-[#D71515]" />
                                </div>
                        ...
                        <div className="group mr-10  p-10 flex-1.5 shadow-lg rounded-lg hover:shadow-xl hover:bg-[#D71515] bg-white ">
                           <div className="group-hover:text-white group-hover:-translate-y-5  transition duration-300" >
                                <div className="pt-5 pb-5">
                                     <FontAwesomeIcon icon={faFigma} size="2x" className="text-[#D71515] group-hover:text-white" />
                                </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="col-start-2  p-7 shadow-lg rounded-lg hover:shadow-xl">
                            ...
                            <div className="flex justify-between mb-3 mt-4 items-center">
                                <a href="https://enviro-backend.onrender.com/" className="text-[#D71515] text-sm font-[500] hover:underline  inline-block group">
                                Explore Enviro 
